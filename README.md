...
| 版本 | 时间 | 主要变化 |
|------|------|---------|
| v3.0.5 | 2026-07-07 | 品牌统一微信号 HelpAgent→xxskill；P3 分级冲突修复（xx-optimize 降级表去 P 编号、SHARED 加交叉说明）；xx-optimize 三件套顺序调整；xx-ai-feature Q4 补成本估算；glossary 补 QPS/openid；性能场景表述改条件式 |
