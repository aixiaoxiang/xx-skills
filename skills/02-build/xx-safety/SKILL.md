---
name: xx-safety
description: AI 安全与合规技能。当产品涉及 AI 输出内容、收集用户数据、准备提交微信小程序审核时使用。覆盖内容审核、隐私合规、AI 输出安全、备案要求，输出上线前合规检查清单。
---

# AI 安全与合规

> AI 产品上线被拒 80% 死在合规，不是技术。先过合规再调优。

## 这个技能做什么

帮你在上线前完成 AI 产品的合规检查，输出一份**上线前合规检查清单**。
